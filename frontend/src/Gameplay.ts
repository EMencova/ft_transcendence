...
<div class="flex justify-center text-center space-x-4">
  <button id="pauseBtn" class="hidden bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600" data-translate="pause_button">Pause</button>
  <button id="resetBtn" class="hidden bg-orange-500 text-white px-4 py-2 rounded hover:bg-orange-600" data-translate="reset_button">Reset</button>
</div>
  `

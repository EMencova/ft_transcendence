    ...
    <div id="startMenu" class="max-w-2xl mx-auto bg-gray-800 border border-gray-700 rounded-lg shadow-lg p-8">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div>
          ...
          <div>
            <label for="winScoreSelect" class="block text-white font-semibold mb-2" data-translate="win_score_label">Win Score:</label>
          ...
          <button id="startBtn" class="w-full bg-orange-500 text-white font-semibold py-3 rounded-lg mb-4 hover:bg-orange-600 transition-colors duration-200" data-translate="start_game">Start Game</button>
        </div>
        ...
        <div id="controlsInfo" class="bg-gray-900 rounded-lg p-4 border border-gray-600">
          ...
          <div id="controlsDisplay" class="text-sm text-gray-300 space-y-2">
            <div class="controls-1player">
              ...
              <div>Player 1: <span class="bg-gray-700 px-2 py-1 rounded" data-translate="controls_p1_up">W</span> / <span class="bg-gray-700 px-2 py-1 rounded" data-translate="controls_p1_down">S</span></div>
      ...
      <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <div class="flex space-x-3">
            <button id="pauseBtn" class="bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600 transition-colors duration-200" data-translate="pause">Pause</button>
            <button id="resetBtn" class="bg-red-500 text-white px-6 py-2 rounded-lg hover:bg-red-600 transition-colors duration-200" data-translate="reset">Reset</button>
          </div>
        </div>

export function createNav(): HTMLElement {
	...
	gameLink.setAttribute("data-translate", "game_link");
	...
	otherGamesLink.setAttribute("data-translate", "other_games_link");
	...
	tournamentLink.setAttribute("data-translate", "tournament_link");
	...
	leaderboardLink.setAttribute("data-translate", "leaderboard_link");
	leaderboardLink.className = linkClass;

	const loginBtn = document.createElement("button");
	loginBtn.id = "loginBtn";
	loginBtn.textContent = "Login";
	loginBtn.setAttribute("data-translate", "login_button");
	loginBtn.className = buttonClass;

	const signupBtn = document.createElement("button");
	signupBtn.id = "signupBtn";
	signupBtn.textContent = "Signup";
	signupBtn.setAttribute("data-translate", "signup_button");
	signupBtn.className = buttonClass;

	const logoutBtn = document.createElement("button");
	logoutBtn.id = "logoutBtn";
	logoutBtn.textContent = "Logout";
	logoutBtn.setAttribute("data-translate", "logout_button");
...
const buttonClass = "ml-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded cursor-pointer";

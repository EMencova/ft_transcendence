...
function createMatchCard(match: any, players: any[]) {
  ...
  if (match.status === "scheduled" && player1 && player2) {
	...
	continueBtn.addEventListener("click", () => startTournamentPongMatch(match, players));
...
//       className:
//         "w-full py-1 bg-green-500 text-white rounded hover:bg-green-600",
//       textContent: "Record Result",
//     });
//     recordBtn.addEventListener("click", () =>
//       recordMatchResult(match.id, select.value)
//     );
...
//   // Create Pong game element
//   const pongGame = document.createElement("div");
//   pongGame.id = `pong-game-${match.id}`;
//   pongGame.className = "pong-game bg-gray-800 rounded";
//   pongGame.style.width = "100%";
//   pongGame.style.height = "500px";
//   pongGame.style.position = "relative";
//   container.appendChild(pongGame);
...
//   player1Info.className = "flex flex-col items-center gap-1";
...
//       <div>S</div>
//     </div>
//     <img src="${player1.avatar || "/avatar.png"}" alt="${
//     player1.username
//   }" class="w-12 h-12 rounded-full">
//   </div>
//   <span class="text-sm font-semibold">${player1.username}</span>
//   <span class="text-xs text-gray-400">W/S Keys</span>
// `;

//   // Score Display
//   const scoreDisplay = document.createElement("div");
//   scoreDisplay.className = "text-white text-xl font-bold";
//   scoreDisplay.innerHTML = `
// 		<span class="player1-score">0</span> - <span class="player2-score">0</span>
// 	`;

//   // Player 2
//   const player2Info = document.createElement("div");
//   player2Info.className = "flex flex-col items-center gap-1";
//   player2Info.innerHTML = `
//   <div class="flex items-center">
//     <img src="${player2.avatar || "/avatar.png"}" alt="${
//     player2.username
//   }" class="w-12 h-12 rounded-full">
...
//     </div>
//   </div>
//   <span class="text-sm font-semibold">${player2.username}</span>
//   <span class="text-xs text-gray-400">↑/↓ Keys</span>
// `;

//   matchHeader.appendChild(player1Info);
//   matchHeader.appendChild(scoreDisplay);
//   matchHeader.appendChild(player2Info);

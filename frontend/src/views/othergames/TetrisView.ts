    ...
    target.innerHTML = `
        <div class="min-h-screen p-4">
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-gray-900 rounded-lg p-6 border border-orange-500">
                    <div class="text-center">
                        <h3 class="text-xl font-bold text-orange-400 mb-4">🎮 Tetris Game</h3>
                        <div class="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-6">
                            ...
                            <div class="bg-gray-800 p-3 rounded">
                                <p class="text-gray-300 text-sm">Lines</p>
                                <p id="tetrisLines" class="text-green-400 font-bold text-xl">0</p>
                            </div>
                            <div class="bg-gray-800 p-3 rounded">
                                <p class="text-gray-300 text-sm">Record</p>
                                <p id="tetrisRecord" class="text-blue-400 font-bold text-xl">${currentUser ? '0' : 'Login'}</p>
                            </div>
                        </div>
                        <button id="startTetrisBtn" class="mb-6 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded font-bold text-lg">
                            🚀 Start Game
                        </button>
                    </div>
            ...
            <div class="max-w-4xl mx-auto mt-6 bg-[#1a1a1a] rounded-lg p-4 border border-gray-700 text-center">
                <p class="text-white font-semibold mb-2">🎮 How to Play Tetris</p>
                <div class="grid grid-cols-2 gap-4 text-sm text-gray-300">
                    <div>
                        <p class="text-orange-400 font-semibold">Controls:</p>
                        <p>🟠 ←/→: Move Left/Right</p>
                        <p>🟠 ↑: Rotate</p>
                        <p>🟠 ↓: Soft Drop</p>
                        <p>🟠 Space: Hard Drop</p>
                    ...
                    <div>
                        <p class="text-green-400 font-semibold">Objective:</p>
                        <p>🏆 Clear lines to score points</p>
                        <p>📊 Level increases every 10 lines</p>
                        <p>⚡ Speed increases with level</p>
                        ${currentUser ? '<p class="text-blue-400 mt-2">💾 Your best score is saved!</p>' : '<p class="text-yellow-400 mt-2">🔒 Login to save your record!</p>'}
                    </div>
                </div>
            </div>
        </div>

                    ...
                    <div class="text-center">
                        ...
                        <div class="grid grid-cols-4 gap-4 max-w-2xl mx-auto mb-6">
                            ...
                            <div class="bg-gray-800 p-3 rounded">
                                ...
                                <p id="tetrisRecord" class="text-blue-400 font-bold text-xl">
                                ${currentUser ? '0' : `<span data-translate="login_to_save_tetr">🔒 Login</span>`}
                                    </p>
...
<div class="max-w-4xl mx-auto mt-6 bg-[#1a1a1a] rounded-lg p-4 border border-gray-700 text-center">
    ...
    <div class="grid grid-cols-2 gap-4 text-sm text-gray-300">
        ...
        <div>
            ...
            ${currentUser ? 
                '<p class="text-blue-400 mt-2" data-translate="best_score_saved">💾 Your best score is saved!</p>' : 
                '<p class="text-yellow-400 mt-2" data-translate="login_to_save">🔒 Login to save your record!</p>'}
        </div>
    </div>
</div>
